...
public class StockPriceDatabean {
    ...
    public String toString() {
        return "StockPriceDatabean{" +
            "uuId='" + uuId + '\'' +
            ", date=" + date + ", openPrice=" + openPrice + ", highPrice=" + highPrice +
            ", lowPrice=" + lowPrice + ", closePrice=" + closePrice + ", wap=" + wap +
            ", noOfShares=" + noOfShares + ", noOfTrades=" + noOfTrades + ", totalTurnover=" + totalTurnover +
            ", deliverableQuantity=" + deliverableQuantity + ", deliQtyToTradedQty=" + deliQtyToTradedQty +
            ", spreadHighLow=" + spreadHighLow + ", spreadCloseOpen=" + spreadCloseOpen + '}';
    }
}
